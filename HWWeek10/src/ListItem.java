...
//		return new ItemIcon(this, diameter);
	...
	//I tried... I do not know how to work with nested classes and interfaces... or how to change something to an adapter pattern
	//also ItemIcon is already implementing a superclass, so how could it possibly implement an interface????
	//ItemIdcon- Jlabel of ListItem
	//add in ItemIcon adapter interface
	//public interface Icon{
	//	public void ItemIcon(ListItem item, int diameter);
	//}
	//make interface extends Icon
	public interface ItIcon extends Icon{
		public void ItemIcon(ListItem item, int diameter);
	}
	public class ItemIcon implements ItIcon {
