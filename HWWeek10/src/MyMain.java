 ...
 *You will have noticed that the Sort button adds multiple copies of the original list to the
 *    ListPanel. Modify the code to ensure that only one copy of the original list
 *    appears.
 * The application does not yet sort the items.  Write the code so that all ListItems are sorted
